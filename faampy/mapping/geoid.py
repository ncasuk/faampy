...
# url: https://github.com/vandry/geoidheight/blob/master/geoid.py
...
class GeoidHeight(object):
    ...
    def __init__(self, name="/usr/share/GeographicLib/geoids/egm2008-1.pgm"):
	self.offset = None
	self.scale = None

        if not os.path.exists(name):
            alt_name=['/usr/share/geographiclib/geoids/egm2008-1.pgm',]
            for alt in alt_name:
