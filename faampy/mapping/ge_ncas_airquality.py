...
"""
Script downloads the model output from the
`NCAS air quality model <https://sci.ncas.ac.uk/airquality/>`_ and creates
a kmz file that is viewable in google-earth. This allows for
...
def get_image(url):
    ...
    :param str url: url of model image
