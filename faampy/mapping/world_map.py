...
def _argparser():
    ...
    parser.add_argument('outpath', action="store", type=str,
                        help='Directory where the images will be stored. Default: $HOME.')
    parser.add_argument('--dpi', action="store", type=int, required=False, default=300,
                        help='resolution dot per inch')
    parser.add_argument('--map_background', action="store_true", required=False, default=False,
...
def main():
    ...
    if args.map_background:        
        # TODO: Images have been removed from repository
