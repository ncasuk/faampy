...
(EPSG:27700) system. However, to make the raster work with for example cis
it is necessary to warp the array to WGS84 (EPSG:4326) so that longitude
and latitude are available as dimensions.

The new netCDF results were tested with the cistools_. If the netCDF
