...
def plot_lwc_rawcounts(ax, data):
    ...
    """
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_lwc_vcol'][:,0].ravel(), '-', label = 'vcol')
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_lwc_icol'][:,0].ravel(), '-', label = 'icol')
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_lwc_vref'][:,0].ravel(), '-', label = 'vref')
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_lwc_iref'][:,0].ravel(), '-', label = 'iref')
...
def plot_twc_rawcounts(ax,data):
    ...
    """
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_twc_vcol'][:,0].ravel(), '-', label = 'vcol')
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_twc_icol'][:,0].ravel(), '-', label = 'icol')
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_twc_vref'][:,0].ravel(), '-', label = 'vref')
    ax.plot_date(data['mpl_timestamp'][:,0].ravel(), data['CORCON_nv_twc_iref'][:,0].ravel(), '-', label = 'iref')
    ax.tick_params(labelbottom='off')
